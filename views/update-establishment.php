...
<head>
    ...
    <title>Update-établissement</title>
    <style>
        body {
            margin-top: 20px;
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="container my-3">
            ...
            <div class="pagetitle bg-white px-3 pb-2 pt-3 mb-4 d-flex align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo BASE_URL."/crud-establishment" ?>">établissement</a></li>
            ...
            <form id='formEstablishment'>
                <input type="hidden" name="id_etablissement_update" id='id_etablissement'>
                <input type="hidden" name="old_logo" id='old_logo'>
                <!-- strat profile -->
                <div class='row'>
                    <div class='col-md-12'>
                        <div class="card">
                            <div class="card-header bg-light  text-dark"> Modifier une établissement
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class='col-md-6 col-12'>
                                        <div class='card' id="file">
                                            <divn class="card-body">
                                                ...
                                                <div class="form">
                                                    <div class="form-row">
                                                        <input class="file-input" type="file" name="logo_update" id="image-input" hidden>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-md-6 col-lg-6 mb-3">
                                        ...
                                        <input class="form-control border-primary" name='libelle_update' id="libelle" type="text" placeholder='Libellé'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                                        ...
                                        <input type="date" name="last_deadline_update" id="last_deadline" class="form-control border-primary" placeholder="dernier délai" required>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        ...
                                        <input type="text" name="Filieres_update" id="Filieres" class="form-control border-primary" placeholder="Filiéres" required>
                                        <span id="error_Filieres" style="display: none">error</span>
                                    </div>
                                </div>
                            </div>
                            <div class="btns mb-3 float-end text-center">
                                <button type="submit" class="btn btn-success text-white px-4" style="font-weight: bolder" id='btnSaveChange'>Modifier</button>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var establishment_id = url.searchParams.get("establishmentId");
            //console.log(establishment_id);  

            // show old data of establishment
            $.ajax({
                type: "GET",
                url: "./controllers/crud-controller.php",
                data: {
                    update_establishment_id: establishment_id
                },
                dataType: 'json',
                success: function(data) {
                    //console.log(data)
                    $("#id_etablissement").val(data['id']);
                    $("#old_logo").val(data['logo']);
                    $('#image-preview').attr("src",data['logo']); 
                    $("#libelle").val(data['title'])
                    $("#Filieres").val(data['sector'])
                    $("#last_deadline").val(data['last_deadline'])
                }
            })
                    ...
                    success: function(response) {
                        ...
                        if ($.trim(response) == "update") {
                            Swal.fire({
                                //position: 'top-end',
                                icon: 'success',
                                title: 'établisments a été modifié avec success',
