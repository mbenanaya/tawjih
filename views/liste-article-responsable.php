...
<header id="header" class="header fixed-top d-flex align-items-center" style='background-color: #2a5eb8;'>
   ...
   <div class="pagetitle bg-white px-3 pb-2 pt-3 mb-5 d-flex align-items-center">
      ...
      <nav>
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./dashboard-responsable">Home</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <div class="card h-100">
          <img src="./uploads/articles/images/<?php echo $article['image']; ?>" class="card-img-top" alt="">
          <div class="card-body">
            <h5 class="card-title"><a href="read-concours-resp?id=<?php echo $article['id']; ?>"><?php echo $article['titre_article']; ?></a></h5>
