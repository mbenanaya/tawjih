...
<body style="background-color: #eee;">
         ...
         <div class="row d-flex justify-content-center">
            <div class="col-md-8">
               <div class="chat-form" style="display:block;width:auto;">
                  ...
                  <div class="chat-box" id="chat_with_studen" style="height:400px;background-color: #F7E6DE;">
                     <!-- MESSAGES -->
                  </div>
                  <form action="#" class="type-area" id="type-area" autocomplete="off" style="background-color: #F7E6DE;">
                     ...
                     <input type="text" value="<?php echo $_GET['id'] ?>"
                      name="<?php echo $_GET['typeUser'] == 'admin' ? 'id_admin':'id_student' ?>" hidden>
                     ...
                     <button id="sendBtnChatResponsable"><i class="fab fa-telegram-plane"></i></button>
                  </form>
               </div>
            </div>
         </div>
   ...
   <!-- end scripts  -->
   <script src="./views/assets/js/chat/chat_with_studen.js"></script>
