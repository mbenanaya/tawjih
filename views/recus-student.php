                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 br-a br-light bg-light pv20 ph30">
                            ...
                            <form id='f' enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="code_massare" name="code_massare" value="<?php echo $_SESSION['codeMassar'] ?>">
                        ...
                        <input type="hidden" id="massar" name="massar" value="<?php echo $_SESSION['codeMassar'] ?>">
