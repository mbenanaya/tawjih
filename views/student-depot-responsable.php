...
<body>
    ...
    <main id="main" class="main pt-1">
        <input type="hidden" id="id_responsible" value="<?php echo $_SESSION['RESPONSABLEINFO']['idRes']; ?>">
        ...
        $(document).ready(function() {
            ...
            function displayAllNotes() {
                $.ajax({
                    ...
                    data: {
                        action: 'display_notes_for_resp',
                        id_responsable : $("#id_responsible").val()
                    },
                    success: function(response) {
                        console.log(response)
