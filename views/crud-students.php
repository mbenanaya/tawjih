...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="export-container">
            ...
            <a href="views/export.php" class="export-button">Exporter</a>
        </div>
        ...
        <div class="container my-5">
            <div class="card border-primary">
                <h5 class="card-header bg-primary d-flex justify-content-between">
                    <span class="text-light lead align-self-center">Tous les étudiants</span>

                    <a href="#" class="btn btn-light" data-toggle="modal" data-target="#addNoteModal"><i class="fas fa-plus-circle fa-lg"></i>&nbsp; Ajouter nouveau étudiant</a>
                </h5>
                <div class="card-body">
                            ...
                            <div class="modal-body">
                                <form method="post" id="add-note-form" class="px-3" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <label for="firstNameArabe">Prénom (Arabic)</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="lastNameArabe">Nom (Arabic)</label>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col-md-6">
                                            <label for="photo">Année de bac</label>
                                            <input type="number" id="bacyear" name="bacyear" class="form-control form-control-lg rounded-0" placeholder="Enter bac year" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="select-lycee" class="form-label">Lycée:</label>
                                            <select class="form-select" id="select-lycee" name="lycee" required>
                                                ...
                                                foreach ($lycees as $lycee) {
                                                    echo '<option value="' . $lycee['idLycee'] . '">' . $lycee['nameFr'] . '</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col-md-6">
                                            <label for="lastNameArabe">Téléphone</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="lastNameArabe">Téléphone parent</label>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <label for="lastNameArabe">Lieu de naissance</label>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="select-region" name="region" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="select-ville" name="ville" required>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col-md-6">
                                            <label for="lastNameArabe">Date de naissance</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="select-bac" name="bac" required>
                                                <option value="" disabled selected>Sélectionnez un type de bac</option>
                                                <?php
                                                $auth = new Auth(); // Instanciation de la classe Auth
