...
<body class='bg-light'>
   ...
   <main id="main" class="main">
      <input type="hidden" readonly name="respId" id="respId" value="<?= $_SESSION['RESPONSABLEINFO']['idRes'] ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           <div class="form-group">
                              ...
                              <input type="hidden" readonly name="rid" id="rid" value="<?= $_SESSION['RESPONSABLEINFO']['idRes'] ?>">

                        <div class="col-sm-5">
                           <button type="submit" id="filterPacksByDuration" name="filterPacksByDur" class="btn btn-primary px-4 mt-2">Filtrer</button>
                        </div>
                     </div>
                  </form>
   ...
   <script src="./views/assets/js/resp_statics.js"></script>
