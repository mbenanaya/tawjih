$(function() {
    ...
    function getTotalCounts() {
        console.log('your id : ' + respId)
        $.ajax({
            type: "post",
            url: "./controllers/RespStaticsController.php",
            data: { respId: respId, action: "getStatics" },
            dataType: "json",
    ...
    function getTodayCounts() {
        $.ajax({
            type: "post",
            url: "./controllers/RespStaticsController.php",
            data: { respId: respId, action: "getTodaysStatics" },
            dataType: "json",
            success: function(data) {
    ...
    function getStudentsCountByPack() {
        $.ajax({
            type: "post",
            url: "./controllers/RespStaticsController.php",
            data: { respId: respId, action: "getStudentsCountByPack" },
            dataType: "json",
            success: function(data) {
                var output = ''
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function() {
                            ...
                            output += '<h2 class="text-right"><i class="fa-solid fa-users f-left"></i>'
                            output += '<span>' + this.studsNumber + '</span></h2>'
                            output += '<p class="mt-3 mb-1 fs-5">Nombre total'
                            output += '<span class="f-right" id="packsNumber">' + this.studsNumber + '</span></p>'
                            output += '</div></div></div>'
                        })
